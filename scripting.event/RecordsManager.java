...
/**
 * JourneyMS
 * RecordsManager - has one object for every world. Not sure if it'll work with multiple parties attempting the same event.
 */
public class RecordsManager {
    ...
    public List<EventRecordEntry> getRecords(String event) {
        return Collections.unmodifiableList(records.get(event));
    }
