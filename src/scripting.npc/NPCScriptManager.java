...
public class NPCScriptManager extends AbstractScriptManager {
    ...
    private String curFunction = null;
    ...
    public void start(MapleClient c, int npc, String filename, MapleCharacter chr) {
        try {
            ...
            if (iv == null || NPCScriptManager.getInstance() == null) {
                System.out.println("Missing NPC Script: "+npc);
                dispose(c);
                return;
            }
            engine.put("cm", cm);
    ...
    public void action(MapleClient c, byte mode, byte type, int selection) {
        ...
        if (iv != null) {
            try {
                if (curFunction != null) {
                    curFunction = (String) iv.invokeFunction(curFunction, mode, type, selection);
                } else {
                    curFunction = (String) iv.invokeFunction("action", mode, type, selection);
                }
